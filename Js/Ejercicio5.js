...
// El algoritmo para calcular la letra del 
// dni es el siguiente :
// El número debe ser entre 0 y 99999999
// Debemos calcular el resto de la división 
// entera entre el número y el número 23.
// Según el resultado, de 0 a 22, le 
// corresponderá una letra de las siguientes:  
...
do {
  ...
  if (isNaN(dni) || dni === null || dni < 0 || dni > 99999999) {
    alert("Error, debe ingresar un número (min 0 - 99999999 max). ");
  }
  else {
    resultado = dni % 23;
    console.log(resultado)
  }
  document.writeln("El DNI ingresado es "+ dni + " equivale a: " + letras.charAt(resultado)+ "<br>");
}
while (confirm("¿Desea ingresar otro DNI?"));
document.writeln("Programa terminado.");
